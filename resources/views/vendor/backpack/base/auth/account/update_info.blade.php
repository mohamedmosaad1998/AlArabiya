            ...
            <div class="box padding-10">
                ...
                <div class="box-body backpack-profile-form">
                    ...
                    <div class="form-group">
                        ...
                        @endphp
                        <label class="required">{{ $label }}</label>
                        <input required class="form-control" type="file" name="{{ $field }}" value="{{ old($field) ? old($field) : $user->$field }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @endphp
                        <label class="required">{{ $label }}</label>
                        <textarea required class="form-control" type="file" name="{{ $field }}">{{ old($field) ? old($field) : $user->$field }}</textarea>
                    </div>
