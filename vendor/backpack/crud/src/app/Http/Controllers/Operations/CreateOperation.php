...
trait CreateOperation
{
    ...
    public function storeCrud(StoreRequest $request = null)
    {
        ...
        $request=new StoreRequest($this->uploadImageS($request));

//        dd($this->uploadImage($request));
        // insert item in the db
        $item = $this->crud->create($request->except(['save_action', '_token', '_method', 'current_tab', 'http_referrer','password_confirmation']));
